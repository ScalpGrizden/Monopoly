...
public class Chance extends Pioche {
    ...
    public Chance(String nom, int position) {
      ...
      CarteChance c1= new CarteChance(0,1,false);
       ...
       CarteChance c5= new CarteChance(20,0,false);
       listeCartesChance.add(c5);
       CarteChance c6= new CarteChance(20,0,false);
       listeCartesChance.add(c6);
       CarteChance c7= new CarteChance(20,0,false);
       listeCartesChance.add(c7);
       CarteChance c8= new CarteChance(100,0,false);
       listeCartesChance.add(c8);
       CarteChance c9= new CarteChance(-100,0,false);
       listeCartesChance.add(c9);
       CarteChance c10= new CarteChance(-20,0,false);
       listeCartesChance.add(c10);
       CarteChance c11= new CarteChance(-20,0,false);
       listeCartesChance.add(c11);
       CarteChance c12= new CarteChance(-10,0,false);
       listeCartesChance.add(c12);
       CarteChance c13= new CarteChance(-10,0,false);
       listeCartesChance.add(c13);
       CarteChance c14= new CarteChance(50,0,false);
